...
public class BD extends SQLiteOpenHelper{
    ...
    private static final String insertTabla_Video = "INSERT INTO video VALUES(NULL,'Categorías Semánticas','ZgWD9ST7js8','Este video trata buscar el elemento que no corresponde a la familia de palabras o categorías semánticasEste video trata buscar el elemento que no corresponde a la familia de palabras o categorías semánticas');";
    ...
    private static final String insertTabla_Video11 = "INSERT INTO video VALUES(NULL,'Letra P ','mkb_CsepflE','Video para que los pequeños descubran y conozcan de manera dinámica la consonante M. Conocerán su sonido, grafema y palabras que comienzan con la consonante M. Incluye ejercicios para practicar a medida que transcurre el video y para trabajar en casa con ayuda de un adulto');";
    ...
    private static final String insertTabla_Video13 = "INSERT INTO video VALUES(NULL,'Las sílabas','mrflP99ujLw','poner descripcion');";
    private static final String insertTabla_Video14 = "INSERT INTO video VALUES(NULL,'El zorro arrepentido','CnTno1ZyLTM','------');";
    private static final String insertTabla_Video15 = "INSERT INTO video VALUES(NULL,'Las vocales ','xzxUI9pmCEE','--------');";
